				...
				<form className="form-horizontal" onSubmit={ this.props.handleUserSignupSubmit }>
					<div className="form-group">
						...
						<div className="col-sm-10">
							<input type="userName" onChange={ this.props.onUsernameChange } value={ this.props.userName } className="form-control" placeholder="Email"/>
						</div>
					</div>
					<div className="form-group">
						<label className="col-sm-2 control-label">First Name</label>
						<div className="col-sm-10">
							<input type="firstName" onChange={ this.props.onFirstNameChange } value={ this.props.firstName } className="form-control" placeholder="Email"/>
						</div>
					</div>
					<div className="form-group">
						<label className="col-sm-2 control-label">Last Name</label>
						<div className="col-sm-10">
							<input type="lastName" onChange={ this.props.onLastNameChange } value={ this.props.lastName } className="form-control" placeholder="Email"/>
						</div>
					</div>
					<div className="form-group">
